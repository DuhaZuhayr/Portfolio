...
export default function Container(props: ContainerProps) {
  ...
  const meta = {
    title: "Duha | Portfolio",
    description: `Computer Science Student, Full-Stack Developer & AI Enthusiast.`,
  ...
  return (
    <>
      <Head>
        ...
        <meta name="theme-color" content="#45357d" />
        <meta content={meta.description} name="description" />
        <meta property="og:url" content={`https://duha.dev${router.asPath}`} />
        <link rel="canonical" href={`https://duha.dev${router.asPath}`} />
        ...
        <meta name="twitter:site" content="Duha" />
      ...
      >
        ...
        <Link href="/">
          <span className="text-lg font-semibold">duha</span>
        </Link>
              ...
              <div className="flex h-full flex-col items-start justify-between overflow-y-auto">
                ...
                <div className="flex min-h-fit w-full flex-col space-y-8 px-[22px] py-10">
                  <span className="text-sm text-muted-foreground">
                    © {new Date().getFullYear()} duha. All rights reserved.
                  </span>
                </div>
              </div>
            </motion.div>
